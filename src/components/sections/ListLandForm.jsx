  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const created = await landApi.create({
        ...
        district: formData.district.trim(),
        address: formData.address.trim(),
        latitude: formData.lat ? parseFloat(formData.lat) : 5.6037,
        longitude: formData.lng ? parseFloat(formData.lng) : -0.187,
        landSize: formData.landSize.trim(),
      ...
      setPublishedSlug(created.slug || localRecord.slug);
