...
import { unsplashUrl, LAND_PHOTO_IDS, CONTRACTOR_PHOTO_IDS, AVATAR_IDS } from "../../constants/stockImages";
  ...
  return (
    <div className="mt-5">
      ...
      <div className="relative overflow-hidden rounded-lg">
        <img
          src={unsplashUrl(LAND_PHOTO_IDS.greenCoveredLand, { w: 400 })}
          alt="Recommended land"
          className="aspect-[4/3] w-full object-cover bg-mist-100"
          loading="lazy"
        />
  ...
  return (
    <div className="mt-5 space-y-3">
      <div className="flex items-center gap-2">
        <img
          src={unsplashUrl(AVATAR_IDS.sarah, { w: 96 })}
          alt="Land Owner"
          className="h-8 w-8 shrink-0 rounded-full object-cover bg-mist-100"
          loading="lazy"
        />
      ...
      <div className="flex items-center gap-2">
        <div className="h-1.5 flex-1 rounded-full bg-ink-900/10" aria-hidden="true" />
        <img
          src={unsplashUrl(AVATAR_IDS.david, { w: 96 })}
          alt="Contractor"
          className="h-8 w-8 shrink-0 rounded-full object-cover bg-mist-100"
          loading="lazy"
        />
...
function CloseBuildVisual() {
  return (
    <div className="mt-5 overflow-hidden rounded-lg">
      <img
        src={unsplashUrl(CONTRACTOR_PHOTO_IDS.modernInterior, { w: 600 })}
